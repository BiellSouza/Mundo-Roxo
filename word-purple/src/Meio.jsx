    ...
    return (
        <main class='flex pt-[10%] w-[100%] h-[auto]'>
            <section className="hero">
                ...
                <div className="hero-img w-[100%] h-[100vh] sm:h-[110vh] md:h-[130vh]">
                    <img class='flex w-[100%]' src="./src/assets/png-meio.png" alt="" />
                    <button class='flex relative left-[37%] top-[5%] border-2 px-[3%] py-[3%] sm:relative sm:left-[40%] md:left-[43%] border-red-700 rounded-[10%] hover:scale-[1.2]' type="submit" className="btn-pedido" id="chamaform">Peça o seu</button>
                </div>
            </section>
        </main>
    )

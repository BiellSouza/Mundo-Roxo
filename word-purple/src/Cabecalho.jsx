    ...
    return (
        <header className="cabecalho shadow-sm w-[100%] h-[8vh] flex items-center justify-between sm:h-[9vh]">
            <div className="logo">
                ...
                <h1 class='font-bold hidden sm:block sm:pl-[30%] text-xl text-red-700'><span class='text-purple-700'>P</span>urple<span class='text-purple-700'>W</span>orld</h1>

            </div>  

            <nav className="navigation">
                <ul className="nav-list font-bold flex flex-row relative right-[20%] gap-[8%] sm:text-[110%] sm:relative sm:left-[2%] hover:text-red-700 transition-[0.5s] ">
            ...
            <div className="icones flex relative right-[6%] top-[5%] text-md gap-[30%] sm:text-[110%] text-purple-700">
